...
## Project Structure
    ...
    ├── custom_av_rack_buil_36839  # Django project configurations
...
1. Clone this repo and `cd custom_av_rack_buil_36839`
...
2. Clone this repo and `cd custom_av_rack_buil_36839`
